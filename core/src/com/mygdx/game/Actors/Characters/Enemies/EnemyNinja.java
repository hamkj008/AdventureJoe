...
/**
 * Ninja has a projectile attack and a melee attack
 */
public class EnemyNinja extends Enemy {
    ...
    public EnemyNinja() {
        ...
        super.setProjectileSpawner(new ProjectileSpawner(this, "Game Objects/NinjaStar.png", "Audio/Sounds/shot.mp3",
